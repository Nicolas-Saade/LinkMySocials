...
from .views import upload_json_file, get_profile_mappings, create_user_profile, check_email, creator_data, personalized_Algorithm_Data, personalized_creator_recommendation, get_following_profiles
...
urlpatterns = [
        ...
        path('profile-mapping/<str:email>/', get_profile_mappings, name='get_profile_mappings'),  # For user profile
        ...
        path('following-profiles/', get_following_profiles, name='get_following_profiles'),  # For following list
]